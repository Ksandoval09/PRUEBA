...
public class juego extends javax.swing.JFrame {
    ...
    public void presionar(int matriz) {
        if (arreglo[matriz - 1].getText().equals("") && estado) {
            arreglo[matriz - 1].setText(turnoX);
            cambiarturno();
            comprobarGanador();
        }
    ...
    public void comprobarGanador() {
        for (int i = 0; i < matrizGanadora.length; i++) {
            if (arreglo[matrizGanadora[i][0] - 1].getText().equals("X") && arreglo[
                    matrizGanadora[i][1] - 1].getText().equals("X") && arreglo[
                            matrizGanadora[i][2] - 1].getText().equals("X")) {
